...
research/literature-2.md the second sweep: 25 more (ducking and low-frequency perception, kick perception, EDM structure, embeddings, musicology, loudness)
research/hypotheses.md   the hypotheses register: 47 entries, tests regenerated by research/test_hypotheses.py
research/advice.md       published production advice as six signal chains (stage -> measure it moves), folklore, and H33-H47
